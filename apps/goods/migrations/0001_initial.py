# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-05-04 09:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sold_nums', models.IntegerField(default=0, verbose_name='销售数')),
                ...
                ('shop_price', models.FloatField(default=0, verbose_name='售卖价')),
                ('goods_brief', models.TextField(max_length=500, verbose_name='商品简介')),
                ('goods_desc', DjangoUeditor.models.UEditorField(default='', verbose_name='内容描述')),
                ('ship_free', models.BooleanField(default=True, verbose_name='是否承担运费')),
                ('goods_front_image', models.ImageField(blank=True, max_length=200, null=True, upload_to='goods/front/%Y/%m', verbose_name='商品图片')),
                ('is_new', models.BooleanField(default=False, verbose_name='新品标志')),
                ('is_hot', models.BooleanField(default=False, verbose_name='热卖标志')),
                ('update_time', models.DateField(default=datetime.datetime.now, verbose_name='更新时间')),
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_tab', models.BooleanField(default=False, help_text='父类', verbose_name='tab栏标志')),
                ('update_time', models.DateField(default=datetime.datetime.now, verbose_name='更新时间')),
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(max_length=200, upload_to='brand/%Y/%m', verbose_name='照片')),
                ('update_time', models.DateField(default=datetime.datetime.now, verbose_name='更新时间')),
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='goods/brand/%Y/%m', verbose_name='商品轮播图片')),
                ('update_time', models.DateField(default=datetime.datetime.now, verbose_name='更新时间')),
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='添加时间')),
